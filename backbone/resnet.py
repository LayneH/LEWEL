...
__all__ = ['resnet18_encoder', 'resnet34_encoder', 'resnet50_encoder', 'resnet101_encoder',
           'resnet50w2x_encoder', 'resnet50w2x_cls']
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, zero_init_residual=False,
                 ...
                 norm_layer=None, width_multiplier=1, with_avgpool=True):
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1)) if with_avgpool else nn.Identity()
    ...
    def _forward_impl(self, x):
        ...
        x = self.avgpool(x)
        x = torch.flatten(x, 1) if self.with_avgpool else x
